...
/// <summary>
/// Provides utility methods for manipulating strings into various naming conventions and formats.
/// </summary>
/// <remarks>
/// Casing conversion methods are taken from the CaseConverter library by Mark Castle.
...
public static class StringUtility
{
    ...
    public static string SplitCamelCase(string input, string splitWith = " ")
    {
    ...
    public static string InsertCharacterBeforeUpperCase(string text,
        char character = ' ')
    {
    ...
    /// <param name="text"></param>
    /// <returns>string</returns>
    public static string InsertSpaceBeforeUpperCase(string text)
    {
        return InsertCharacterBeforeUpperCase(text);
    }
    ...
    {
        return FirstCharToLowerCase(Regex.Replace(text, "_[a-z]", m => m.ToString().TrimStart('_').ToUpper()));
    }
