...
public interface IQueryExecutor
{
    ...
    public Task<TResult> QuerySingleAsync<TResult>(string query, object? parameters, IDbTransaction? dbTransaction = null, CancellationToken cancellationToken = default);
    ...
    /// </returns>
    /// <exception cref="NonUniqueResultException">Thrown if the query returns more than one result.</exception>
    public Task<TResult?> QuerySingleOrDefaultAsync<TResult>(string query, object? parameters, IDbTransaction? dbTransaction = null, CancellationToken cancellationToken = default);
